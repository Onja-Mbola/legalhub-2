...
Revision ID: c5688ccad8b5
Revises: 
Create Date: 2025-08-04 17:23:08.605439
...
def downgrade() -> None:
    ...
    sa.Column('role_client', sa.VARCHAR(), autoincrement=False, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('nom', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('qualite', sa.VARCHAR(), autoincrement=False, nullable=False),
    ...
    sa.Column('type_affaire', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('sous_type_affaire', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('urgence', sa.VARCHAR(), autoincrement=False, nullable=True),
    ...
    sa.PrimaryKeyConstraint('id', name=op.f('param_general_pkey'))
    )
